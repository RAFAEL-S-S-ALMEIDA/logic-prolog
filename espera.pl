espera(Esp) :-
    ...
    camisa(L,azul),
    horario(L1,11),
    %A pessoa de camisa Verde está em algum lugar entre a pessoa com camisa Vermelha e a pessoa de camisa Azul.
    entre(M,M1,M2,Esp),
    camisa(M,vermelha),
    camisa(M1,verde),
    camisa(M2,azul),
    ...
    %O paciente da Dra. Priscila está exatamente à direita de quem está com a revista Caras.
